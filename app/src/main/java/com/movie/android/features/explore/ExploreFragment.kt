package com.movie.android.features.explore
...
import com.movie.android.features.popular.explore.ExploreAdapter
import com.movie.android.features.popular.explore.ExploreUiState
import com.movie.android.features.popular.explore.ExploreUiState.Failure
import com.movie.android.features.popular.explore.ExploreUiState.Success
...
class ExploreFragment : Fragment() {
    ...
    private val showMorePopulars: () -> Unit = {
        findNavController().navigate(
            ExploreFragmentDirections.actionExploreFragmentToMainFragment()
        )
    }

    private val showMoreUpcoming: () -> Unit = {
        findNavController().navigate(
            ExploreFragmentDirections.actionExploreFragmentToUpcomingFragment()
        )
    }

    private val exploreAdapter = ExploreAdapter(showMorePopulars, showMoreUpcoming)
